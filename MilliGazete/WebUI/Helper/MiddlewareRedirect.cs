...
{
    public class MiddlewareRedirect
    {
        private readonly RequestDelegate _next;

        public MiddlewareRedirect(RequestDelegate next)
        {
            _next = next;
        }
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            if (isMobile(userAgent)) //mobile ise
            {
                string url = LayoutModel.WebMobileUIUrl+context.Request.Path;
