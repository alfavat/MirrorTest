...
public class ApiHelper
{
    ...
    /// <returns></returns>
    public static async Task<PagingResult<T>> GetPagingApiAsync<T>(string url, string token = "") where T : class
    {
        try
        {
            using (HttpHelper http = new HttpHelper())
            {
                var res = await http.RequestAsync<dynamic>(new RequestObject()
                {
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public static async Task<IDataResult<T>> GetApiAsync<T>(string url, string token = "")
    {
        try
        {
            using (HttpHelper http = new HttpHelper())
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public static async Task<IDataResult<T>> PostDataApiAsync<T>(string url, dynamic body, string token = "")
    {
        try
        {
            using (HttpHelper http = new HttpHelper())
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public static async Task<IResult> PostNoDataApiAsync(string url, dynamic body, string token = "")
    {
        try
        {
            using (HttpHelper http = new HttpHelper())
