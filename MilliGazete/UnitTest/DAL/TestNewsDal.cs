        ...
        INewsDal MockNewsDal()
        {
            ...
            for (int i = 1; i <= dataCount; i++)
            {
                db.News.Add(new News()
                {
                    ...
                    AddUserId = 15,
                    NewsTags = new List<NewsTag> { new NewsTag { TagId = 15, NewsId = i, Tag = new Tag { Deleted = false, TagName = "tagname", Url = "url" } } },
                    IsLastNews = false,
                    ...
                    NewsCounters = new List<NewsCounter> { },
                    NewsFiles = new List<NewsFile> { new NewsFile { NewsFileTypeEntityId = (int)NewsFileTypeEntities.NormalImage, File = new File { FileName = "", IsCdnFile = true } } },
                    NewsPositions = new List<NewsPosition> { },
                    NewsProperties = new List<NewsProperty> { },
